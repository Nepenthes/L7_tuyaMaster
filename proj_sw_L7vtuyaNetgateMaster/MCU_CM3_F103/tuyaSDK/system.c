...
static void wifi_uart_write_data(unsigned char *in, unsigned short len)
{
  ...
  extern void uartConWifi_dataTxPort(unsigned char *data, unsigned short dataLen);	
...
static void product_info_update(void)
{
  ...
  length = set_wifi_uart_buffer(length, ",\"cap\":", my_strlen(",\"cap\":"));
  length = set_wifi_uart_buffer(length, (unsigned char *)MCU_CAP, my_strlen((unsigned char *)MCU_CAP));
