...
#define USRAPP_OSSIGNAL_DEF_UART3_RX_TOUT			(1UL << 2)
#define USRAPP_OSSIGNAL_DEF_UART4_RX_TOUT			(1UL << 3)
#define USRAPP_OSSIGNAL_DEF_UART5_RX_TOUT			(1UL << 4)
...
#define UART_DATA_RCV_TEMP_LENGTH			128
